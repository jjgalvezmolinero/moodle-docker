    ...
    def habilitar_entornos(self, action):
        ...
        try:
            if(action == 'enable_phpunit'):
                ...
                subprocess.run(['docker', 'exec', selected_container] + command.split(), check=True)
                self.ejecutar_comando(selected_container, "echo 'zend_extension=xdebug.so' >> /usr/local/etc/php/conf.d/docker-php-ext-xdebug.ini")
                self.ejecutar_comando(selected_container, "echo 'xdebug.remote_enable = 1' >> /usr/local/etc/php/conf.d/docker-php-ext-xdebug.ini")
                self.ejecutar_comando(selected_container, "echo 'xdebug.remote_autostart = 1' >> /usr/local/etc/php/conf.d/docker-php-ext-xdebug.ini")
                ...
                self.ejecutar_comando(selected_container, "echo 'xdebug.discover_client_host = 1' >> /usr/local/etc/php/conf.d/docker-php-ext-xdebug.ini")
                self.ejecutar_comando(selected_container, "echo 'xdebug.log = /tmp/xdebug_remote.log' >> /usr/local/etc/php/conf.d/docker-php-ext-xdebug.ini")
                self.ejecutar_comando(selected_container, "echo 'xdebug.var_display_max_depth=10' >> /usr/local/etc/php/conf.d/docker-php-ext-xdebug.ini")
                self.ejecutar_comando(selected_container, "echo 'xdebug.var_display_max_children=250' >> /usr/local/etc/php/conf.d/docker-php-ext-xdebug.ini")
                self.ejecutar_comando(selected_container, "echo 'xdebug.var_display_max_data=10000' >> /usr/local/etc/php/conf.d/docker-php-ext-xdebug.ini")
                self.ejecutar_comando(selected_container, "echo 'xdebug.output_dir=/tmp/xdebug/' >> /usr/local/etc/php/conf.d/docker-php-ext-xdebug.ini")
                self.ejecutar_comando(selected_container, "echo 'xdebug.remote_host= 172.18.104.58 (hostname -I)' >> /usr/local/etc/php/conf.d/docker-php-ext-xdebug.ini")
                self.ejecutar_comando(selected_container, "echo 'xdebug.cliente_port= 9003' >> /usr/local/etc/php/conf.d/docker-php-ext-xdebug.ini")
                self.ejecutar_comando(selected_container, "echo 'xdebug.remote_port= 9003' >> /usr/local/etc/php/conf.d/docker-php-ext-xdebug.ini")
